      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          >
            <StatsCard
              ...
              value={dashboardStatsMock.quizAverage + "%"}
              icon={<Files size={24} />}
              color="bg-[#e7f9ee] text-[#1c9c4c]"
            />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: -20 }}
          ...
          >
            <StatsCard
              label="GIỜ HỌC"
              value={dashboardStatsMock.studyHours + "h"}
              icon={<BookOpen size={24} />}
              color="bg-[#edf6ff] text-[#344054]"
            />
          </motion.div>
        </div>
        ...
        >
          <div className="relative h-48">
            <img
              src={currentEnrolledCourseMock.image}
              alt="Khóa học"
          ...
          <div className="p-6 flex-1 flex flex-col justify-between">
            ...
            <button
              ...
              className="w-full bg-on-primary-fixed-variant text-white py-3.5 rounded-lg font-bold flex items-center justify-center gap-3 hover:bg-primary transition-colors active:scale-[0.98]"
            >
